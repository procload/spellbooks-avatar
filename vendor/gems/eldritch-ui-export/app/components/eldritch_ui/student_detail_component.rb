module EldritchUi
  class StudentDetailComponent < ViewComponent::Base
    def initialize(student:, assignments: [], show_edit_link: true, **html_attributes)
      @student = student
    ...
    attr_reader :student, :assignments, :show_edit_link
    ...
    def show_edit_link?
      show_edit_link && student&.persisted?
    end

    def edit_student_path
      return unless student&.persisted?
      Rails.application.routes.url_helpers.edit_student_path(student)
    end
